...
type Project struct { //科研项目
	Id             int       `json:"id"`                                             //序号
	Title          string    `json:"name" binding:"required"`                        //项目名称
	...
	CreateDate     time.Time `gorm:"type:date" json:"createDate" binding:"required"` //立项时间
...
type ProjectOmitempty struct {
	...
	CreateDate     time.Time `gorm:"type:date" json:"createDate" binding:"omitempty"`
